...
const contentEntities: EntityItem[] = [
  ...
  { id: 'suppliers', name: 'Поставщики', path: '/content/suppliers', icon: '🚚' },
  { id: 'cakes', name: 'Торты', path: '/content/cakes', icon: '🎂' },
  { id: 'show-programs', name: 'Шоу-программы', path: '/content/show-programs', icon: '🎭' },
  { id: 'decorations', name: 'Декорации', path: '/content/decorations', icon: '🎨' },
];
